...
public class PanelUsuarios extends JPanel {
    ...
    private void editarUsuarioSeleccionado() {
        ...
        btnGuardar.addActionListener(e -> {
            ...
            // CORRECCIÓN: Validar que se ingrese contraseña
            if (nuevaPassword.isEmpty()) {
                mostrarMensajeError("Debe ingresar una nueva contraseña para actualizar el usuario");
                return;
            }

            // CORRECCIÓN: Validar longitud mínima
            ...
            try {
                ...
                usuario.setContrasena(nuevaPassword); // CORRECCIÓN: Usar la contraseña ingresada
